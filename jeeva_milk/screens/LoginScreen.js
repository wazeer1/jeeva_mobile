  ...
  const handleLogin = async () => {
    ...
    if (username.length > 3 && password.length > 3) {
        try {
            ...
            Alert.alert('Error','An error occurred during login. Please try again.', [{ text: 'OK' }], { cancelable: false });
        }
    } else {
        Alert.alert('Validation Error', 'Username and password required', [{ text: 'OK' }], { cancelable: false });
        setError(true);
    }
};
  return (
    ...
    >
      <View style={styles.MainContaine}>
        ...
        <View style={styles.ContainerWhite}>
          ...
          <Text style={styles.SubHead}>Login with the credentials provided from the society.</Text>
