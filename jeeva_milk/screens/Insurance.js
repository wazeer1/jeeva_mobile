      ...
      <View style={styles.topCover}>
        ...
        <View
          ...
          <View style={styles.cardData}>
            <View>
              <Text style={{color: '#878787', fontSize: 14, paddingBottom: 7}}>
                Total
              </Text>
            </View>
            <View
              style={{flexDirection: 'row', alignItems: 'flex-end', gap: 5}}>
              <Text style={{color: '#49BFD4', fontSize: 22, fontWeight: '600'}}>
          ...
          <View style={styles.cardData}>
            ...
            <View
              style={{flexDirection: 'row', alignItems: 'flex-end', gap: 5}}>
              <Text style={{color: '#4A4D4E', fontSize: 22, fontWeight: '600'}}>
